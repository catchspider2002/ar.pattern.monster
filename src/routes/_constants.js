const strings = {
  ...
  description: "مولد أنماط عبر الإنترنت بسيط لإنشاء انماط svg مكررة.",
  description2: "قم بتسريع موقعك على الإنترنت بدون التأثير على جودة الصورة.",
  description3: "مناسب لخلفيات المواقع على الإنترنت، والمظاهر، والعلامات التجارية، وتصاميم التغليف والمزيد.",
  keywords: "أنماط Svg، الأنماط، خلفيات Svg ، خلفيات فيكتور، ومولد النمط، صانع النمط",
  pages: [
    {
      page: "index",
      title: "مولد نمط SVG",
